...
const LogMeal = () => {
  ...
  return (
    <div className="flex justify-center items-center px-2 md:px-0 min-h-screen bg-slate-200 relative">
      {
        loading && (
          <div className='flex items-start justify-center absolute inset-0 z-21 bg-black/60 h-full'>
              <div className='flex gap-2 mt-[60%] md:mt-[30%] bg-gray-400 py-1 px-2 rounded-md'>
