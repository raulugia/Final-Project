...
const HomeMealCard = React.forwardRef(({mealName, restaurantName, logId, mealId, createdAt, rating, picture, carbEstimate, isOtherUser, user}, ref) => {
    ...
    >   
        <div className='min-h-1/2 flex flex-col items-center bg-gradient-to-t from-blue-500 to-cyan-500 relative pt-2'>
            <div className='mb-3'>
                <p className='text-white font-bold text-2xl'>{mealName.toUpperCase()}</p>
                <p className='text-white font-semibold'>{restaurantName}</p>
            </div>
            <div className='w-[250px] min-h-[250px] rounded-3xl overflow-hidden z-20 shadow-md'>
            ...
            <div className='flex items-center justify-center border rounded-3xl bg-white w-[340px] h-[320px] absolute top-[130px] shadow-lg'>
                <div className='flex flex-col gap-6 mt-[170px]'>
                    <p className='text-sm mx-10 h-[20px] leading-[15px] text-slate-600 font-semibold'>This is a description for my meal and this is not</p>
