  ...
  return (
    ...
    >
      <div className="flex items-center justify-between gap-10">
        ...
        <div className='flex md:flex-row flex-col md:gap-5 lg:gap-20 md:items-center'>
          <p className={`text-md lg:text-xl font-semibold text-slate-800 ${isHovered === username ? "underline" : ""}`}>{name} {surname}</p>
          <p className={"text-sm lg:text-lg text-slate-400"}>@{username}</p>
        </div>
      </div>
